        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-primary-500 to-accent-500 rounded-xl blur opacity-40 group-hover:opacity-70 transition-opacity duration-300"></div>
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl glass-light hover:bg-white/10 transition-all duration-300 text-sm text-slate-300 hover:text-white group"
            id="github-link"
          >
